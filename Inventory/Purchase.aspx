<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Purchase.aspx.cs" Inherits="Purchase.Purchase" %>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <asp:TextBox ID="txtPurchaseNo" runat="server" CssClass="col-sm-4" Style="margin-left: 7px" AutoPostBack="true" OnTextChanged="txtPurchaseNo_TextChanged" Font-Bold="True"></asp:TextBox>
                                <br />
                                <br />
                                <div class="row">
                                    <asp:Label ID="Label4" runat="server" Style="margin-left: 16px" Text="Payment Type "></asp:Label>
                                    <asp:DropDownList ID="ddlPaymentType" runat="server" Style=" width: 159px;">
                        ...
                        <div class="col-lg-4">
                            <asp:TextBox ID="txtPurchaseInvoice" runat="server" CssClass=" col-sm-4 float-right" Font-Bold="True"></asp:TextBox>
                        ...
                        <br />
                        <asp:TextBox ID="txtSubTotal" runat="server" CssClass="float-right" Style="padding-right: 21px"></asp:TextBox>
                        ...
                        <br />
                        <br />
                        <asp:TextBox ID="txtTotal" runat="server" CssClass="float-right" Font-Bold="True"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtNotes" runat="server" Style="margin-left: 40px" Height="36px"></asp:TextBox>
                        ...
                        <a onclick="MyPopUpWin('/Report.aspx',1100,600); return false;" style="margin-right: 10px; color: #fff" class=" btn btn-success m-t-n-xs float-right"><i class="fa fa-print"></i>&nbsp;Print</a>
