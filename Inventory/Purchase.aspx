            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <asp:DropDownList ID="ddlPaymentType" runat="server" CssClass="form-control" style="margin-left:4px; width: 159px;">
                        ...
                        <asp:TextBox ID="txtNotes" runat="server" CssClass="form-control form-control-sm width" style="margin-left: 40px" ></asp:TextBox>
